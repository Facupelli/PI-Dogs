        ...
        <div>
          <div>
            <div className={s.navbar}>
              <Link to="/home" className={s.dogApp}>
                THE DOG APP
              </Link>
              <Link to="/createbreed" className={s.createBreed}>
                CREATE BREED
              </Link>
            </div>
          </div>
          <div className={s.detail}>
            ...
            <div className={s.infoContainer}>
              ...
              <div className={s.measuresContainer}>
                ...
                <p className={s.measure}>{dog[0].weight} kg</p>
              </div>
              <div className={s.measuresContainer}>
                <p className={s.measure}>Height:</p>
                <p className={s.measure}>{dog[0].height} cm</p>
              </div>
              <div className={s.measuresContainer}>
